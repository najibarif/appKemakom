...
const Footer = ({ setCurrentPage }) => {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#0F4639] to-[#A6B933] text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Universitas Pendidikan Indonesia</p>
              </div>
            </div>
        ...
        <div className="mt-12 p-6 lg:p-8 bg-white/10 rounded-2xl backdrop-blur-sm max-w-3xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              <h4 className="font-display font-semibold text-xl mb-2">Newsletter</h4>
              <p className="text-white/80">Dapatkan update terbaru dari kami</p>
            </div>
            <div className="flex-1 max-w-2xl">
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-white/60 focus:outline-none focus:border-yellow-400 backdrop-blur-sm"
                />
                <button className="px-6 py-3 bg-yellow-400 text-[#0F4639] font-semibold rounded-lg hover:bg-white transition-colors duration-300 whitespace-nowrap">
                  Subscribe
                </button>
              </div>
            </div>
        ...
        <div className="border-t border-white/20 mt-16 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/80 text-center md:text-left">
              &copy; 2025 BEM Keluarga Mahasiswa Komputer UPI. All Rights Reserved.
            </p>
