  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#A6B933] rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-32">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="animate-fade-in-up">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold mb-8 leading-tight bg-gradient-to-r from-[#ffffff] to-[#fbf5af] bg-clip-text text-transparent">
          ...
          <div className="animate-fade-in-up flex flex-col sm:flex-row gap-6 justify-center mb-20" style={{ animationDelay: '0.4s' }}>
            <button
              ...
              className="group inline-flex items-center px-8 py-4 bg-white text-[#0F4639] font-semibold text-lg rounded-xl hover:bg-[#A6B933] hover:text-white transform hover:scale-105 transition-all duration-300 shadow-strong hover:shadow-lg"
            >
              Jelajahi Fitur
            ...
            <button
              ...
              className="group inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold text-lg rounded-xl hover:bg-white hover:text-[#0F4639] transform hover:scale-105 transition-all duration-300"
            >
          ...
          <div className="animate-fade-in-up grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto" style={{ animationDelay: '0.6s' }}>
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="bg-white/10 backdrop-blur-md rounded-2xl p-8 hover:scale-105 transition-transform duration-300">
                  <div className="w-16 h-16 bg-gradient-to-r from-[#0F4639] to-[#A6B933] rounded-xl flex items-center justify-center mb-6 mx-auto">
